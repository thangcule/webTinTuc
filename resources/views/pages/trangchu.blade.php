	            ...
	            <div class="panel panel-default">            
	            	...
	            	<div class="panel-body">
					    ...
					    <div class="row-item row">
		                	...
		                	<div class="col-md-8 border-right" style="padding: 10px auto;">
		                		<div class="col-md-5">
			                        <a href="tintuc/{{$tin1['id']}}/{{$tin1['TieuDeKhongDau']}}.html">
			                            <img class="img-responsive" src="upload/tintuc/{{$tin1['Hinh']}}" style="margin-top: 20px; margin:auto;width: 100%; top: -2px;" alt="">
			                        </a>
			                    </div>

			                    <div class="col-md-7">
			                        <a href="tintuc/{{$tin1['id']}}/{{$tin1['TieuDeKhongDau']}}.html">
			                        	<h3 style="margin-top: 0px; margin-bottom: 10px;">{{$tin1['TieuDe']}}</h3>
			                        </a>
